...
private:
    ...
    QString nomSite_Lu;//contient le nom du site récupéré dans le formulaire IHM
    QString adresse_Lue;//contient Adresse IP récupérée dans le formulaire IHM
...
public:
    ...
    void Add(QString nomSite, QString adresseIP);// Méthode pour ajouter une nouvelle configuration
    void Edit();
